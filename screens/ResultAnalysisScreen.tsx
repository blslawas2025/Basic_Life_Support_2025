...
const styles = StyleSheet.create({
  ...
  trendItem: {
    flex: 1,
    alignItems: 'center',
    marginHorizontal: getResponsiveSize(2, 4, 6),
  },
  trendLabel: {
  ...
  detailedAnswerPercentage: {
    ...
    fontWeight: '600',
    color: '#6b7280',
    minWidth: getResponsiveSize(32, 40, 48),
    textAlign: 'right',
  },
  detailedCorrectMark: {
    fontSize: getResponsiveFontSize(12, 14, 16),
  ...
  answerChoiceLabel: {
    width: getResponsiveSize(24, 32, 40),
    height: getResponsiveSize(24, 32, 40),
    borderRadius: getResponsiveSize(12, 16, 20),
    alignItems: 'center',
    justifyContent: 'center',
  ...
  answerChoiceText: {
    ...
    fontSize: getResponsiveFontSize(12, 14, 16),
    color: '#1f2937',
    lineHeight: getResponsiveSize(16, 20, 24),
  },
  answerChoiceStats: {
    alignItems: 'flex-end',
  },
