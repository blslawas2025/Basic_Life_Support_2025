      ...
      <Animated.View style={[
        ...
        <View style={styles.headerContent}>
          <Animated.View style={[
            ...
            >
              <Ionicons name="help-circle" size={getResponsiveSize(28, 32, 36)} color="#ffffff" />
            </LinearGradient>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  previewModalHeader: {
    ...
    paddingTop: getResponsiveSize(20, 25, 30),
  ...
  previewMalayText: {
    ...
    fontWeight: '600',
    color: '#ffffff',
    lineHeight: getResponsiveFontSize(26, 28, 30),
    marginBottom: getResponsiveSize(8, 10, 12),
  },
  previewEnglishText: {
  ...
  previewAnswerLabel: {
    ...
    color: '#00d4ff',
    marginRight: getResponsiveSize(12, 16, 20),
    minWidth: getResponsiveSize(24, 28, 32),
  },
  previewAnswerText: {
    flex: 1,
  },
  ...
  categoryCardGradient: {
    ...
    alignItems: 'center',
    minHeight: getResponsiveSize(160, 180, 200),
    justifyContent: 'center',
  },
  categoryIcon: {
  ...
  questionsOrganizedContainer: {
    gap: getResponsiveSize(24, 30, 36),
  },
  questionsSection: {
    gap: getResponsiveSize(16, 20, 24),
  },
  ...
  questionsOrganizedAnswerLabel: {
    ...
    minWidth: getResponsiveSize(16, 18, 20),
  },
  ...
  questionsEmptySection: {
    alignItems: 'center',
    justifyContent: 'center',
    paddingVertical: getResponsiveSize(32, 40, 48),
