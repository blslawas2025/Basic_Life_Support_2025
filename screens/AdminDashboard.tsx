    ...
    <View style={styles.dashboard}>
      ...
      <Animated.View style={[
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            <Animated.Text style={[
              styles.dashboardTitle,
              {
                textShadowColor: glowAnim.interpolate({
                  inputRange: [0, 1],
                  outputRange: ['rgba(0, 255, 136, 0)', 'rgba(0, 255, 136, 0.8)']
                })
              }
            ]}>
              Admin Dashboard
            ...
            <Text style={styles.dashboardSubtitle}>Manage Your Department</Text>
          </View>
        </View>
      ...
      >
        ...
        <Animated.View style={[
          ...
          <Text style={styles.statsTitle}>Department Overview</Text>
          <View style={styles.statsGrid}>
            <View style={styles.statCard}>
              ...
              <Text style={styles.statLabel}>My Participants</Text>
            ...
            <View style={styles.statCard}>
              <View style={styles.statIcon}>
                <Ionicons name="school" size={24} color="#5b73ff" />
              </View>
            ...
            <View style={styles.statCard}>
              <View style={styles.statIcon}>
                <Ionicons name="time" size={24} color="#ff0080" />
              </View>
              <Text style={styles.statNumber}>45</Text>
              <Text style={styles.statLabel}>Pending Reviews</Text>
              <View style={styles.statTrend}>
                <Ionicons name="alert-circle" size={16} color="#ff0080" />
                <Text style={styles.statTrendText}>New</Text>
              </View>
            </View>
          </View>
            ...
            >
              <View style={styles.approvePanelHeader}>
                ...
                <View style={styles.approvePanelContent}>
                  <Text style={styles.approvePanelTitle}>Approve Participants</Text>
            ...
            {[
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.actionCard,
                  {
                    width: windowDims.width < 375 ? windowDims.width - 32 : windowDims.width < 768 ? (windowDims.width - 60) / 2 : (windowDims.width - 72) / 3,
                    opacity: fadeAnim,
                    transform: [
                      { 
                        translateY: slideAnim.interpolate({
